    ...
    public String persist(@Valid @ModelAttribute Supplier supplier, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if (supplier.getId() == null) {
            ...
            if (DBSupplier == null) {
                ...
                supplier.setCode("KMSS"+makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                supplier.setCode("KMSS"+makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
