package lk.krishan_mobile.asset.report;
...
import lk.krishan_mobile.asset.common_asset.model.NameCount;

import lk.krishan_mobile.asset.common_asset.model.ParameterCount;
import lk.krishan_mobile.asset.common_asset.model.TwoDate;
...
import lk.krishan_mobile.asset.ledger.service.LedgerService;
import lk.krishan_mobile.asset.payment.entity.Payment;
import lk.krishan_mobile.asset.payment.service.PaymentService;
import lk.krishan_mobile.asset.purchase_order_item.service.PurchaseOrderItemService;
import lk.krishan_mobile.asset.report.model.ItemSellPriceQuantityBuyingPrice;
import lk.krishan_mobile.asset.report.model.LedgerQuantitySellPrice;
import lk.krishan_mobile.asset.user_management.user.service.UserService;
import lk.krishan_mobile.util.service.DateTimeAgeService;
import lk.krishan_mobile.util.service.OperatorService;
...
public class ReportController {
  ...
  public ReportController(PaymentService paymentService, InvoiceService invoiceService,
      ...
      CustomerService customerService, PurchaseOrderItemService purchaseOrderItemService,
  ...
  private void commonPerItem(LocalDateTime startDateTime, LocalDateTime endDateTime, Model model) {
    ...
    invoiceItems.forEach(x -> {
      ...
      List<InvoiceLedger> itemInvoiceLedger = invoiceLedgers.stream().filter(y -> y.getLedger().getItem().equals(x))
          .collect(Collectors.toList());
