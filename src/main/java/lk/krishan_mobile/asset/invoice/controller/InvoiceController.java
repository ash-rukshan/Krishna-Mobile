package lk.krishan_mobile.asset.invoice.controller;
...
import lk.krishan_mobile.asset.discount_ratio.service.DiscountRatioService;
...
import lk.krishan_mobile.asset.ledger.controller.LedgerController;
    ...
    public String persistInvoice(@Valid @ModelAttribute Invoice invoice, BindingResult bindingResult, Model model) {
        ...
        if (invoice.getId() == null) {
            if (invoiceService.findByLastInvoice() == null) {
                ...
                invoice.setCode("KMSI" + makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                invoice.setCode("KMSI" + makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
        }
